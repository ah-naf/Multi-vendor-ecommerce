// File Path: src/app/dashboard/components/Sidebar.tsx
"use client";
...
const NavLink = ({ href, icon: Icon, children, isActive = false }) => (
  <a
    href={href}
...
export const Sidebar = () => (
  <aside className="hidden md:flex md:w-20 lg:w-64 bg-white border-r border-gray-200 p-4 flex-col justify-between">
    <div>
      ...
      <nav className="flex flex-col space-y-2">
        ...
        <NavLink href="#" icon={Box}>
          Products
        </NavLink>
        <NavLink href="#" icon={ShoppingBag}>
          Orders
        </NavLink>
        <NavLink href="#" icon={CreditCard}>
          Payments
        </NavLink>
      </nav>
    </div>
